...
/**
 * Strings for component 'auth_mnetsync', language 'en'.
 *
...
$string['auth_mnetsync_auto_add_remote_users'] = 'When set to Yes, a local user record is auto-created when a remote user logs in for the first time.';
$string['auth_mnetsyncdescription'] = 'Users are authenticated according to the web of trust defined in your Moodle Network settings.';
$string['auth_mnetsync_roamin'] = 'These host\'s users can roam in to your site';
$string['auth_mnetsync_roamout'] = 'Your users can roam out to these hosts';
$string['auth_mnetsync_rpc_negotiation_timeout'] = 'The timeout in seconds for authentication over the XMLRPC transport.';
...
$string['pluginname'] = 'MNet authentication with custom user field sync';
